...
class ProyectoController extends Controller
{
    ...
    public function solicitudes_proyectos(string $id)
    {
        ...
        $solicitudes = Solicitud::where('id_proyecto', $id)->get(); //Obtener todas las solicitudes de un proyecto
        $estudianteId = $solicitudes->pluck('id_estudiante'); //Obtener los id de los estudiantes que solicitaron el proyecto
        $proyecto = Proyecto::find($id); //Obtener el proyecto
        $estudiantes = Estudiante::whereIn('id_estudiante', $estudianteId)->get(); //Obtener los estudiantes que solicitaron el proyecto
        $usuarios = User::whereIn('id_usuario', $estudiantes->pluck('id_usuario'))->get(); //Obtener los usuarios que solicitaron el proyecto
        $estados = Estado::all(); //Obtener los estados de los proyectos
        $nombresEstudiantes = $usuarios->pluck('name'); //Obtener los nombres de los estudiantes que solicitaron el proyecto
